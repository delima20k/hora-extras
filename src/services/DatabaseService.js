...
const DB_VERSION = 3;
const STORES = ['employees', 'workSchedules', 'payrollSettings', 'overtimeEntries', 'payrollClosures', 'appSettings'];
...
export class DatabaseService {
  ...
  async open() {
    ...
    request.onupgradeneeded = () => {
      ...
      if (!db.objectStoreNames.contains('payrollClosures')) { const store = db.createObjectStore('payrollClosures', { keyPath: 'id' }); store.createIndex('employeeId', 'employeeId', { unique: false }); }
