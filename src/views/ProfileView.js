...
export class ProfileView {
  render(container, state, { avatarUrl, onSubmit, onFileChange }) {
    ...
    const closing = input('payroll-closing-day', 'number', payroll.payrollClosingDay || ''); closing.required = true; closing.min = '1'; closing.max = '31';
