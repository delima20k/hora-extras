...
export class OvertimeEntry {
  constructor({ id = newId(), employeeId, date, startTime, endTime, durationMinutes, notes = '', status = 'active', paymentStatus = 'pending', receivedAt = null, createdAt = new Date().toISOString(), updatedAt = createdAt } = {}, timeCalculationService = defaultTimeCalculationService) {
